...
public class TelaLista2 extends JFrame{
	// Desenvolve a Parte Grafica | JFrame | Funcionários sem comissão
	public TelaLista2(List<Funcionario> funcionario) {
		...
		JLabel etiqueta=new JLabel("Lista dos Funcionarios sem comissão mensal:");
		...
		botao.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(listaGrafica.getSelectedIndex()!=-1) {
					...
					JOptionPane.showMessageDialog(null, funcionario.get(i).toString());	
				}
			}
		});
		...
		botaoeditarnome.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(listaGrafica.getSelectedIndex()!=-1) {
					...
					funcionario.get(i).nomeFuncionario=JOptionPane.showInputDialog("“Por Favor, defina um novo nome:”");
		...
		botaoeditarsalario.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(listaGrafica.getSelectedIndex()!=-1) {
					...
					funcionario.get(i).salario=Integer.parseInt(JOptionPane.showInputDialog("“Por Favor, defina um novo Salário:”"));
